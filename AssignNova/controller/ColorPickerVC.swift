...
class ColorPickerVC: UIViewController {
	...
	static let colors = [
        ...
        Color(color: UIColor(hex: "#FFFF00")!, name: "Yellow"),
        Color(color: UIColor(hex: "#FFEF00")!, name: "Canary Yellow"),
        Color(color: UIColor(hex: "#FFF380")!, name: "Corn Yellow"),
        Color(color: UIColor(hex: "#FFE87C")!, name: "Sun Yellow"),
